...
public class ZinemaTest {
	...
	public void getIdTest() {
		Zinema z1 = new Zinema(1, "Elorrieta Zinema", "San Ignazio", 658659874, null, "elorrietazinema@gmail.com",
				"17:00-23:00");
	...
	public void getAretoaTest() {
		...
		Zinema z2 = new Zinema(1, "Elorrieta Zinema", "San Ignazio", 658659874, aretoak, "elorrietazinema@gmail.com",
				"17:00-23:00");
	...
	public void setAretoaTest() {
		Aretoa[] aretoak = new Aretoa[] { new Aretoa(1, "Areto1", null, "10/02/2024", "17:00-23:00") };
		Zinema z2 = new Zinema(1, "Elorrieta Zinema", "San Ignazio", 658659874, null, "elorrietazinema@gmail.com",
				"17:00-23:00");
		z2.setAretoak(aretoak);
		assertArrayEquals(aretoak, z2.getAretoak());
	}
	...
	public void testToString() {
		Aretoa[] aretoak1 = { new Aretoa(1, "Aretoa1", null, "01/02/2024", "18:00"),
	...
	public void testEquals() {
		...
		Aretoa[] aretoak2 = { new Aretoa(3, "Aretoa3", null, "01/02/2024", "18:00"),
