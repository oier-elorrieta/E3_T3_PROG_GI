...
public class ErosketaTest {
	...
	public void getIdTest() {
		Erosketa e1 = new Erosketa(1, 4, "02/02/2024", "deskriptzioa", 24.3);
    ...
    public void equalsTest() {
		...
		Erosketa e1 = new Erosketa(1, 4, "02/02/2024", "deskriptzioa", 24.3);
		Erosketa e2 = new Erosketa(1, 4, "02/02/2024", "deskriptzioa", 24.3);
		Erosketa e3 = new Erosketa(2, 4, "02/02/2024", "deskriptzioa", 24.3);

        assertTrue(e1.equals(e2)); // mismos valores, deberían ser iguales
        assertFalse(e1.equals(e3)); // diferente ID, deberían ser diferentes
